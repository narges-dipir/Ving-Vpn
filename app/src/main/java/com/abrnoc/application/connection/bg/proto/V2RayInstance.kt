...
package com.abrnoc.application.connection.bg.proto
...
import com.abrnoc.application.connection.neko.PluginManager
import com.abrnoc.application.connection.neko.updateAllConfig
import com.abrnoc.application.ftm.LOCALHOST
import com.abrnoc.application.ftm.V2rayBuildResult
...
import com.abrnoc.application.ftm.wireguard.buildWireGuardUapiConf
...
import com.abrnoc.application.presentation.connection.isExpertFlavor
...
abstract class V2RayInstance(
    ...
    val externalInstances = hashMapOf<Int, io.nekohasekai.sagernet.AbstractInstance>()
