package com.abrnoc.application.presentation.navigation
...
import com.abrnoc.application.presentation.screens.help.HelpScreen
    ...
    NavHost(
        ...
        builder = {
            ...
            composable(
                ...
                content = { HelpScreen(navController = navController) }
            )
        }
    )
}