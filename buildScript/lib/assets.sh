...
curl -fLSsO https://github.com/v2fly/v2ray-core/releases/download/v5.7.0/v2ray-extra.zip
...
curl -fLSsO https://github.com/v2ray/geoip/releases/download/20190509.1/geoip.dat
xz geoip.dat
...
curl -fLSs -o geosite.dat.xz https://github.com/v2fly/domain-list-community/releases/latest/download/dlc.dat.xz
