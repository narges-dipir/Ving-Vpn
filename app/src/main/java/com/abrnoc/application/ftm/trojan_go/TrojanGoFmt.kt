...
package com.abrnoc.application.ftm.trojan_go
...
import com.abrnoc.application.ftm.shadowsocks.fixInvalidParams
...
import com.abrnoc.application.presentation.connection.urlSafe
...
fun TrojanGoBean.buildTrojanGoConfig(port: Int): String {
    return JSONObject().apply {
        ...
        if (plugin.isNotBlank()) {
            ...
            com.github.shadowsocks.plugin.PluginManager.init(pluginConfiguration)?.let { (path, opts, isV2) ->
